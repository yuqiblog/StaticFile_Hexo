...
(function (t) {
  ...
  function e() {
    ...
    t(".tabs .nav-tabs").on("click", "a", (e) => {
      ...
      return (
        i.find(".nav-tabs .active").removeClass("active"),
        i.find(e.target.parentElement).addClass("active"),
        i.find(".tab-content .active").removeClass("active"),
        i.find(t(e.target).attr("class")).addClass("active"),
        !1
      );
    });
  }
